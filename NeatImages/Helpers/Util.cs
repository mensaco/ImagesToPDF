...
console.log(dimensions.width + ' × ' + dimensions.height);
    ...
    public class Util
    {
        ...
        //public static (int width, int height) GetDimensions(string data)
        //{
        //    string ws = data.Substring(16, 4);
        //    string hs = data.Substring(20, 4);

        //    int wi = ToInt32(System.Text.Encoding.UTF8.GetBytes(ws));
        //    int hi = ToInt32(System.Text.Encoding.UTF8.GetBytes(hs));
        //    return (wi, hi);

        //}

        public static (int width, int height) GetPngDimensions(string dataUri)
        {
            byte[] b;

            var p = dataUri.Split("base64,");

            b = Convert.FromBase64String(p[1].Substring(0, 32));

            // 32 base64 characters encode the necessary 24 bytes
            return (b[18] << 8 | b[19], b[22] << 8 | b[23]);
        }
